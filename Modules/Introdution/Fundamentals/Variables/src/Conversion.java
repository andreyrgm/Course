...
public class Conversion {
    public static void main(String[] args) {
        out.println("Example 1: System.Conversion from String to int");
        String numStr = "50";
        ...
        out.println("\nExample 8: System.Conversion from int to short (with possible loss of precision)");
        int i = 22768;
        short s = (short) i;
        out.println("s = " + s);
        out.println("Short.MAX_VALUE = " + Short.MAX_VALUE);

        out.println("\nExample 9: System.Conversion from int to long");
        long l = i;
        out.println("l = " + l);
        ...
        out.println("\nExample 11: System.Conversion from int to float");
