...
public class Form extends HttpServlet {
    ...
    /**
     * Maneja la solicitud HTTP POST. Valida la entrada del usuario y muestra el resultado o los errores.
     *
     * @param req  El objeto HttpServletRequest que contiene la solicitud que el cliente realizó al servlet
     * @param resp El objeto HttpServletResponse que contiene la respuesta que el servlet devuelve al cliente
